...
<div class="header_bar">
    <a href="index.php" style="text-decoration: none; color:black;"><img src="images/download.jpeg" alt="O" style="height: 40px; width: 40px; margin: 18px 3px -10px 30px;">
    <span style="font-family: Roboto;/*! text-decoration: none; */font-size: 26px;"><strong>WEB</strong>chat</span></a>
